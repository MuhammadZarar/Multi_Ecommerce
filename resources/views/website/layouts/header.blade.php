...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('website/css/video-js.css') }}" />
    <link rel="stylesheet" type="text/css" href="website/css/style.css?v=<?php echo rand(111, 999); ?>" />
