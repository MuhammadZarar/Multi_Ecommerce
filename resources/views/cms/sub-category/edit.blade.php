    ...
    <div class="page-body-wrapper sidebar-icon">
        ...
        <div class="page-body">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <form id="form_edit_sub_category">
                                @csrf
                                            ...
                                            <div class="col">
                                                <div class="text-end">
                                                    <input class="btn btn-primary me-3" type="submit"
                                                        id="edit_sub_category_btn" value="Submit">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            $(document).ready(function() {
                $(document).on("submit", "#form_edit_sub_category", function(e) {
                    e.preventDefault();
                    $("#edit_sub_category_btn").prop('disabled', true);
                    ...
                    if (category_id == '' || sub_category == '' || sub_slug == "") {
                        ...
                        `), setTimeout(function() {
                            $(".sub_category_notify").html(``);
                            $("#edit_sub_category_btn").prop('disabled', false);
                        }, 2000);
                    } else {
                        $.ajax({
                            url: `{{ route('update_sub_category') }}`,
                            type: 'POST',
                            data: formData,
                            processData: false,
                            contentType: false,
